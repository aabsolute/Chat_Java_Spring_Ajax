...
<head>
    ...
    <!-- <link rel="shortcut icon" type="image/x-icon" href="/resources/main/img/favicon.png"> -->
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center">
                        <img src="/resources/main/img/banner/flowers.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="/resources/main/img/story/1.png" alt="">
                        </div>
                        <span>Groom</span>
                        <h3>Jack Wonner</h3>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="single_lover_story text-center">
                        <div class="story_thumb">
                            <img src="/resources/main/img/story/2.png" alt="">
                        </div>
                        <span>Bride</span>
                        <h3>Anjelina Kona</h3>
                        <p>Many variations of passages of Lorem Ipsum available, but the majority have suffered
                ...
                <div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                    <div class="main_attending_area">
                        ...
                        <div class="flower_2 d-none d-lg-block">
                            <img src="/resources/main/img/appointment/flower-bottom.png" alt="">
                        </div>
